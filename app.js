...
// const Student.courseName = () => `This student is enrolled in Code 301.`
...
// When joe.scope() is invoked, "this" is the properties of the joe object.
// 2. What is "this" when joe.scopeArrow() is invoked?
//"this" doesn't work with an arrow function because scope doesn't work the same way with them.
// 3. Explain why "this" is different when an arrow function is used.
//this is not bound to arrow functions, the value used for arrow functions would be fetched from the scope it sits inside. Source: https://medium.com/@iampika/es6-arrow-functions-syntax-and-lexical-scoping-d061732071e7
